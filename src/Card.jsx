    ...
    return<>
        <div class="main">
            ...
            <div class="container">
                ...
                <div class="data">
                    <div class="d">
                        <img src={require('./icons8-empty-bed-50.png')} alt="" />
                        <p class="t">Bed</p>
                        <p class="digit">2</p>
                    </div>
                    <div class="d">
                        <img src={require('./icons8-bath-48.png')} alt="" />
                        <p class="t">Bath</p>
                        <p class="digit">2</p>
                    </div>
                    <div class="d">
                        <img src={require('./icons8-city-buildings-48.png')} alt="" />
                        <p class="t">Levels</p>
                        <p class="digit">2</p>
                    </div>
                    <div class="d">
                        <img src={require('./icons8-surface-64.png')} alt="" />
                        <p class="t">Sqft</p>
                        <p class="digit">2</p>
                    </div>
                </div>
